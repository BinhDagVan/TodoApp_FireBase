    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        <View style={styles.inputWrapper}>
          <Text style={{fontSize:20, marginBottom:5, alignSelf:'baseline'}}>Thêm Tên Dịch Vụ</Text>
          <TextInput
        ...
        <View style={styles.inputWrapper}>
        <Text style={{fontSize:20, marginBottom:5, alignSelf:'baseline'}}>Thêm Giá Tiền</Text>
          <TextInput
      ...
      <Text style={{fontSize:20, justifyContent:"center", marginLeft: 30}}>Thêm Ảnh</Text>
        <IconButton
          icon="plus"
          color="#FFFFFF"
          size={30}
